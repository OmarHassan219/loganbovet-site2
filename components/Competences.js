...
export const SavoirFaire = () => {
  return (
    <div className="section savoirfaire section_" id="competences">
...
export const SavoirEtre = () => {
  return (
    <div className="section savoiretre section_" id="competences">
      <div className="content">
        <div className="title">
...
export const Langues = () => {
  ...
  return (
    <div className="section langues section_" id="competences">
      <div className="content">
        <div className="title">
