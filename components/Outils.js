        ...
        <div className="content">
          ...
          <div className="box-items outils-items">
            ...
            <div className="box-item f-dev">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/dev/access.png" alt="access" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-wiki">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/wiki/alfresco.png" alt="alfresco" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-remote">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/remote/anydesk.png" alt="anydesk" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-hebergeur">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/hebergeur/aws.png" alt="aws" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-protection">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/protection/bitdefender.png" alt="bitdefender" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-collab">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/collab/discord.png" alt="discord" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-dev">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/dev/docker.png" alt="docker" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-tickets">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/tickets/freshdesk.png" alt="freshdesk" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-montage">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/montage/gimp.png" alt="gimp" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-dev">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/dev/gitlab.png" alt="gitlab" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-collab">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/collab/google-forms.png" alt="google forms" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-hebergeur">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/hebergeur/infomaniak.png" alt="infomaniak" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-dev">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/dev/java.png" alt="java" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-wiki">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/wiki/mediawiki.png" alt="mediawiki" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-collab">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/collab/microsoft365.png" alt="windows 365" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-dev">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/dev/mysql.png" alt="mysql" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-dev">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/dev/nodejs.png" alt="nodejs" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-dev">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/dev/notepad.png" alt="notepad" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-dev">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/dev/npm.png" alt="npm" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-hebergeur">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/hebergeur/o2switch.png" alt="o2switch" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-tickets">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/tickets/otrs.png" alt="otrs" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-hebergeur">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/hebergeur/ovh.png" alt="ovh" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-remote">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/remote/parsec.png" alt="parsec" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-montage">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/montage/photoshop.png" alt="photoshop" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-montage">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/montage/premierepro.png" alt="premiere pro" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-remote">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/remote/rdp.png" alt="rdp" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-dev">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/dev/framework/react.png" alt="reactjs" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-cms">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/cms/shopify.png" alt="shopify" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-montage">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/montage/sonyvegas.png" alt="sony vegas" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-collab">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/collab/surveymonkey.png" alt="surveymonkey" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-dev">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/dev/framework/svelte.png" alt="svelte" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-collab">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/collab/teams.png" alt="teams" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-collab">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/collab/trello.png" alt="trello" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-dev">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/dev/typescript.png" alt="typescript" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-hebergeur">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/hebergeur/vercel.png" alt="vercel" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-dev">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/dev/vscode.png" alt="visual studio code" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-wiki">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/wiki/wikijs.png" alt="wikijs" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-os">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/os/Windows10.png" alt="windows 10" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-os">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/os/Windows11.png" alt="windows 11" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-os">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/os/windows-server.png" alt="windows server" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-cms">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/cms/wordpress.png" alt="wordpress" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-collab">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/collab/xenforo.png" alt="xenforo" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-tickets">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/tickets/zammad.png" alt="zammad" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
            ...
            <div className="box-item f-tickets">
              ...
              <div className="desc">
                <div className="category">Tickets</div>
                <a href="https://www.zendesk.fr/" target="_blank" className="name has-popup-link">
                  Zendesk
                </a>
              </div>
            </div>
            ...
            <div className="box-item f-voip">
              <div className="image">
                <a
                  ...
                  target="_blank"
                >
                  <img src="/images/outils/voip/zoiper.png" alt="zoiper" />
                  <span className="info">
                    <span className="centrize full-width">
                      <span className="vertical-center">
                        <span className="ion ion-link" />
